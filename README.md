...
**想背什么，自己决定。** 单词、法条、诗句、考点、错题、名言……任何你想记住的内容，都可以自由录入，剩下的交给艾宾浩斯遗忘曲线：系统自动安排每天该复习什么，间隔逐级拉长，让你记得牢、忘得慢。

- 🧠 **艾宾浩斯自动排期**：录入内容后无需操心，每天打开就知道该背什么
- ✍️ **内容完全由你掌控**：自己录入、自己编辑，背什么由你决定
- 💾 **纯本地离线**：数据只存自己电脑的 SQLite，免费无广告、无需联网、无需注册
- 🖥️ **轻量桌面应用**：Python + customtkinter，Windows 直接下载 exe 免安装运行
